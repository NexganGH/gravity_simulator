...
class Renderer {
 ...
 public:
   ...
   * @param universeWidth The width of the universe in meters, so that bodies can be scaled
   * accordingly.
  */
  ...
  */
  ...
  /**
   * Draw the shape on screen. The position is converted automatically to pixels - from
   * meters.
   * 
  ...
  */
  ...
  /**
   * Convers the vector from screen (pixel) coordinates to real (meters) coordinates.
   * 
 ...
 /**
   * Converts the vector from real (pixel) coordinates to screen (meters) coordinates.
   * 
