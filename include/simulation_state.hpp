...
class SimulationState {
 private:
  ...
  // This is the physics engine used to simulate. Calculates gravity, body evolution. 
 ...
 public:
  ...
  /**
   * Resets the simulation state to initial values, according to the configuration.
   * 
   * @param conf If passed, resets according to this configuration. If not passed, resets * according to the configuration in use.
  */
