...
\begin{figure} [H]
    \centering
    \includegraphics[height=.20\linewidth]{Menù.png}
    \captionof{figure}{Il menù presente nella parte alta a sinistra dell'interfaccia serve a selezionare delle simulazioni prefabbricate. Cliccandone una essa comparirà nello schermo. Le possibilità sono: Solar system till mars, Solar system, Earth and Sun, Star collapsing, Two planets, Two planets 2, Three planets, Binary stars, Collapsing binary stars.}
    \label{playpause}
\end{figure}
